...
title: "2.1 Projectlocatie tekenen"
...
<div style="line-height:1.5; margin:0; padding:0;">
  <img src="2.1image.svg" style="display:block; margin:0;" />
  <span style="font-size:0.8em; display:block; margin:0;">Figuur 2.1</span>
</div>
...
1\.	Als eerst selecteer je de kaartlaag ‘Projectlocatie’ (1 in Figuur 2.1).

2\.	Zet bewerken van de kaartlaag aan in de taakbalk (het potloodje).

3\.	Geef aan dat je een nieuw gebied wilt tekenen.
