...
<div style="line-height:1.5; margin:0; padding:0;">
  <img src="2.2image.svg" style="display:block; margin:0;" />
  <span style="font-size:0.8em; display:block; margin:0;">Figuur 2.2</span>
</div>
...
<li>Sla vervolgens de kaartlaag op <li>{{ "[3 KAARTLAGEN]({{< ref \"/manual/3KAARTLAGEN/\" >}})" | markdownify }}</li>  [3 KAARTLAGEN]({{< ref "/manual/3KAARTLAGEN/" >}}). De kaartlaag wordt opgeslagen onder het mapje ‘Shape’ in de ‘GIS’-map van het project en krijgt de naam ‘onderzoekspunten’.</li> 
