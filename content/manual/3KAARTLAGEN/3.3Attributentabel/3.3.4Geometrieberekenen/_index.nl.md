...
Indien je een nieuwe Shapefile hebt aangemaakt voor bijvoorbeeld een tracé, dan kan je middels de attributentabel de lengte berekenen. Dit doe je als volgt (zie Figuur 23):
...
<li>Area: hiermee bereken je de oppervlakte van bijvoorbeeld een locatie<sup>1</sup>.</li>
...
![Alt text](./3.3.4image.svg)



<sup>1</sup>Indien het oppervlak verandert van de locatie, dan kan je dit opnieuw berekenen. Open opnieuw de ‘veldberekening’ en vink nu ‘bestaande velden vernieuwen’ aan (6 in Figuur 23). Selecteer de betreffende kolom en druk vervolgens op ‘OK’.
